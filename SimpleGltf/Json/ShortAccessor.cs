...
{
    public class ShortAccessor : IAccessor
    {
        private readonly bool _minMax;
        private readonly int _componentCount;
        private readonly int _columns;
        private readonly int _rows;
        private readonly List<short> _values;

        internal ShortAccessor(BufferView bufferView, AccessorType type, bool minMax, bool normalized, string name)
        {
