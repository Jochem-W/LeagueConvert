...
{
    [JsonProperty(PropertyName = "other_class")]
    public string OtherClass { get; private set; }

    [JsonProperty(PropertyName = "offset")]
    public uint Offset { get; private set; }

    [JsonProperty(PropertyName = "bitmask")]
...
{
    [JsonProperty(PropertyName = "vtable")]
    ...
    [JsonProperty(PropertyName = "value_size")]
    public uint ValueSize { get; private set; }

    [JsonProperty(PropertyName = "fixed_size")]
...
{
    public override BinPropertyType ReadJson(JsonReader reader, Type objectType,
        [AllowNull] BinPropertyType existingValue, bool hasExistingValue, JsonSerializer serializer)
    {
...
{
    public override MetaDumpMapStorageType ReadJson(JsonReader reader, Type objectType,
        [AllowNull] MetaDumpMapStorageType existingValue, bool hasExistingValue, JsonSerializer serializer)
    {
        var storage = reader.Value as string;
    ...
    public override void WriteJson(JsonWriter writer, [AllowNull] MetaDumpMapStorageType value,
...
{
    public override MetaDumpContainerStorageType? ReadJson(JsonReader reader, Type objectType,
        [AllowNull] MetaDumpContainerStorageType? existingValue, bool hasExistingValue, JsonSerializer serializer)
    {
        var storage = reader.Value as string;
        return storage switch
        {
    ...
    public override void WriteJson(JsonWriter writer, [AllowNull] MetaDumpContainerStorageType? value,
        JsonSerializer serializer)
    {
        throw new NotImplementedException();
    }
