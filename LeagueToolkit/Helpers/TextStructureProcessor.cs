...
{
    /// <summary>
    ///     Parses a <see cref="Vector2" /> structure from the provided string assuming the vector components are separated by
    ///     a space
    /// </summary>
    ...
    /// <summary>
    ///     Parses a <see cref="Vector2" /> structure from the provided string array assuming each item is a separate vector
    ///     component
    /// </summary>
    ...
    /// <summary>
    ///     Parses a <see cref="Vector3" /> structure from the provided string assuming the vector components are separated by
    ///     a space
    /// </summary>
    ...
    /// <summary>
    ///     Parses a <see cref="Vector3" /> structure from the provided string array assuming each item is a separate vector
    ///     component
    /// </summary>
    ...
    /// <summary>
    ///     Converts a <see cref="Vector2" /> to string with the components being separated by a space and formatted by
    ...
    /// <summary>
    ///     Converts a <see cref="Vector2" /> to string with the components being separated by <paramref name="separator" />
    ///     and formatted by <paramref name="format" />
    /// </summary>
    /// <param name="vector">The <see cref="Vector2" /> to convert</param>
    /// <param name="separator">The character to separate the vector components</param>
    /// <param name="format">Format of the vector components</param>
    ...
    {
        return string.Format("{0}{1}{2}", vector.X.ToString(format, CultureInfo.InvariantCulture), separator,
    ...
    /// <summary>
    ///     Converts a <see cref="Vector3" /> to string with the components being separated by a space and formatted by
    ///     <paramref name="format" />
    /// </summary>
    /// <param name="vector">The <see cref="Vector3" /> to convert</param>
    /// <param name="format">Format of the vector components</param>
    ...
    {
        return string.Format("{1}{0}{2}{0}{3}", separator, vector.X.ToString(format, CultureInfo.InvariantCulture),
            vector.Y.ToString(format, CultureInfo.InvariantCulture),
